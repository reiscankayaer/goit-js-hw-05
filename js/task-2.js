...
console.log(getUsersWithFriend(allUsers, "Briana Decker")); // Sharlene Bush ve Sheree Anthony döner
console.log(getUsersWithFriend(allUsers, "Goldie Gentry")); // Elma Head ve Sheree Anthony döner
console.log(getUsersWithFriend(allUsers, "Adrian Cross")); // [] döner